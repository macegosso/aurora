    ...
    >
      ...
      <div className="wrap relative z-10 w-full">
        <div className="max-w-[720px] py-28">
          ...
          <h1 className="font-display text-[clamp(68px,13vw,168px)] leading-[0.9] font-bold tracking-[-0.04em]">
          ...
          <div
            className="anim-hero-in mt-10 grid max-w-[520px] grid-cols-3 gap-5 border-t border-line pt-6"
